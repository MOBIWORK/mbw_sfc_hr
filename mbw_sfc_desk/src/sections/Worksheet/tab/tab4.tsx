...
export default function Tab4({ data, total, setPage, page, clDate }: any) {
  const PAGE_SIZE = 20;
            ...
            >
              <Column
                ...
                render={(value: any, record: any) => {
                  ...
                  } else if(value?.number_of_hours === undefined){
                    return <div>x</div>
                  }
                  
                  else {
                    return <div className="items-center">{value?.number_of_hours}</div>;
                  }
