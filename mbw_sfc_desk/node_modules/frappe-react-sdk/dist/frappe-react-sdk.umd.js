 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Es;function oa(){if(Es)return at;Es=1;var n=De.default,e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,s=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,i={key:!0,ref:!0,__self:!0,__source:!0};function o(c,l,a){var h,f={},v=null,g=null;a!==void 0&&(v=""+a),l.key!==void 0&&(v=""+l.key),l.ref!==void 0&&(g=l.ref);for(h in l)r.call(l,h)&&!i.hasOwnProperty(h)&&(f[h]=l[h]);if(c&&c.defaultProps)for(h in l=c.defaultProps,l)f[h]===void 0&&(f[h]=l[h]);return{$$typeof:e,type:c,key:v,ref:g,props:f,_owner:s.current}}return at.Fragment=t,at.jsx=o,at.jsxs=o,at}var ut={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ss;function aa(){return Ss||(Ss=1,process.env.NODE_ENV!=="production"&&function(){var n=De.default,e=Symbol.for("react.element"),t=Symbol.for("react.portal"),r=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),i=Symbol.for("react.profiler"),o=Symbol.for("react.provider"),c=Symbol.for("react.context"),l=Symbol.for("react.forward_ref"),a=Symbol.for("react.suspense"),h=Symbol.for("react.suspense_list"),f=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),g=Symbol.for("react.offscreen"),b=Symbol.iterator,w="@@iterator";function S(u){if(u===null||typeof u!="object")return null;var p=b&&u[b]||u[w];return typeof p=="function"?p:null}var _=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;function C(u){{for(var p=arguments.length,y=new Array(p>1?p-1:0),E=1;E<p;E++)y[E-1]=arguments[E];F("error",u,y)}}function F(u,p,y){{var E=_.ReactDebugCurrentFrame,D=E.getStackAddendum();D!==""&&(p+="%s",y=y.concat([D]));var V=y.map(function(A){return String(A)});V.unshift("Warning: "+p),Function.prototype.apply.call(console[u],console,V)}}var m=!1,W=!1,O=!1,M=!1,L=!1,q;q=Symbol.for("react.module.reference");function P(u){return!!(typeof u=="string"||typeof u=="function"||u===r||u===i||L||u===s||u===a||u===h||M||u===g||m||W||O||typeof u=="object"&&u!==null&&(u.$$typeof===v||u.$$typeof===f||u.$$typeof===o||u.$$typeof===c||u.$$typeof===l||u.$$typeof===q||u.getModuleId!==void 0))}function ee(u,p,y){var E=u.displayName;if(E)return E;var D=p.displayName||p.name||"";return D!==""?y+"("+D+")":y}function te(u){return u.displayName||"Context"}function X(u){if(u==null)return null;if(typeof u.tag=="number"&&C("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),typeof u=="function")return u.displayName||u.name||null;if(typeof u=="string")return u;switch(u){case r:return"Fragment";case t:return"Portal";case i:return"Profiler";case s:return"StrictMode";case a:return"Suspense";case h:return"SuspenseList"}if(typeof u=="object")switch(u.$$typeof){case c:var p=u;return te(p)+".Consumer";case o:var y=u;return te(y._context)+".Provider";case l:return ee(u,u.render,"ForwardRef");case f:var E=u.displayName||null;return E!==null?E:X(u.type)||"Memo";case v:{var D=u,V=D._payload,A=D._init;try{return X(A(V))}catch{return null}}}return null}var U=Object.assign,Fe=0,ct,lt,we,ft,It,Ee,Se;function Pe(){}Pe.__reactDisabledLog=!0;function Vt(){{if(Fe===0){ct=console.log,lt=console.info,we=console.warn,ft=console.error,It=console.group,Ee=console.groupCollapsed,Se=console.groupEnd;var u={configurable:!0,enumerable:!0,value:Pe,writable:!0};Object.defineProperties(console,{info:u,log:u,warn:u,error:u,group:u,groupCollapsed:u,groupEnd:u})}Fe++}}function We(){{if(Fe--,Fe===0){var u={configurable:!0,enumerable:!0,writable:!0};Object.defineProperties(console,{log:U({},u,{value:ct}),info:U({},u,{value:lt}),warn:U({},u,{value:we}),error:U({},u,{value:ft}),group:U({},u,{value:It}),groupCollapsed:U({},u,{value:Ee}),groupEnd:U({},u,{value:Se})})}Fe<0&&C("disabledDepth fell below zero. This is a bug in React. Please file an issue.")}}var He=_.ReactCurrentDispatcher,Je;function Ye(u,p,y){{if(Je===void 0)try{throw Error()}catch(D){var E=D.stack.trim().match(/\n( *(at )?)/);Je=E&&E[1]||""}return`
`+Je+u}}var ht=!1,ge;{var jt=typeof WeakMap=="function"?WeakMap:Map;ge=new jt}function B(u,p){if(!u||ht)return"";{var y=ge.get(u);if(y!==void 0)return y}var E;ht=!0;var D=Error.prepareStackTrace;Error.prepareStackTrace=void 0;var V;V=He.current,He.current=null,Vt();try{if(p){var A=function(){throw Error()};if(Object.defineProperty(A.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(A,[])}catch(Te){E=Te}Reflect.construct(u,[],A)}else{try{A.call()}catch(Te){E=Te}u.call(A.prototype)}}else{try{throw Error()}catch(Te){E=Te}u()}}catch(Te){if(Te&&E&&typeof Te.stack=="string"){for(var R=Te.stack.split(`
`),re=E.stack.split(`
`),H=R.length-1,G=re.length-1;H>=1&&G>=0&&R[H]!==re[G];)G--;for(;H>=1&&G>=0;H--,G--)if(R[H]!==re[G]){if(H!==1||G!==1)do if(H--,G--,G<0||R[H]!==re[G]){var fe=`
`+R[H].replace(" at new "," at ");return u.displayName&&fe.includes("<anonymous>")&&(fe=fe.replace("<anonymous>",u.displayName)),typeof u=="function"&&ge.set(u,fe),fe}while(H>=1&&G>=0);break}}}finally{ht=!1,He.current=V,We(),Error.prepareStackTrace=D}var Xe=u?u.displayName||u.name:"",Ps=Xe?Ye(Xe):"";return typeof u=="function"&&ge.set(u,Ps),Ps}function I(u,p,y){return B(u,!1)}function Q(u){var p=u.prototype;return!!(p&&p.isReactComponent)}function j(u,p,y){if(u==null)return"";if(typeof u=="function")return B(u,Q(u));if(typeof u=="string")return Ye(u);switch(u){case a:return Ye("Suspense");case h:return Ye("SuspenseList")}if(typeof u=="object")switch(u.$$typeof){case l:return I(u.render);case f:return j(u.type,p,y);case v:{var E=u,D=E._payload,V=E._init;try{return j(V(D),p,y)}catch{}}}return""}var ne=Object.prototype.hasOwnProperty,Re={},z=_.ReactDebugCurrentFrame;function K(u){if(u){var p=u._owner,y=j(u.type,u._source,p?p.type:null);z.setExtraStackFrame(y)}else z.setExtraStackFrame(null)}function de(u,p,y,E,D){{var V=Function.call.bind(ne);for(var A in u)if(V(u,A)){var R=void 0;try{if(typeof u[A]!="function"){var re=Error((E||"React class")+": "+y+" type `"+A+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof u[A]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw re.name="Invariant Violation",re}R=u[A](p,A,E,y,null,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED")}catch(H){R=H}R&&!(R instanceof Error)&&(K(D),C("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).",E||"React class",y,A,typeof R),K(null)),R instanceof Error&&!(R.message in Re)&&(Re[R.message]=!0,K(D),C("Failed %s type: %s",y,R.message),K(null))}}}var Mt=Array.isArray;function ze(u){return Mt(u)}function qt(u){{var p=typeof Symbol=="function"&&Symbol.toStringTag,y=p&&u[Symbol.toStringTag]||u.constructor.name||"Object";return y}}function oe(u){try{return le(u),!1}catch{return!0}}function le(u){return""+u}function Ke(u){if(oe(u))return C("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.",qt(u)),le(u)}var Be=_.ReactCurrentOwner,dt={key:!0,ref:!0,__self:!0,__source:!0},Os,xs,Hn;Hn={};function Ta(u){if(ne.call(u,"ref")){var p=Object.getOwnPropertyDescriptor(u,"ref").get;if(p&&p.isReactWarning)return!1}return u.ref!==void 0}function Ca(u){if(ne.call(u,"key")){var p=Object.getOwnPropertyDescriptor(u,"key").get;if(p&&p.isReactWarning)return!1}return u.key!==void 0}function Oa(u,p){if(typeof u.ref=="string"&&Be.current&&p&&Be.current.stateNode!==p){var y=X(Be.current.type);Hn[y]||(C('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref',X(Be.current.type),u.ref),Hn[y]=!0)}}function xa(u,p){{var y=function(){Os||(Os=!0,C("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",p))};y.isReactWarning=!0,Object.defineProperty(u,"key",{get:y,configurable:!0})}}function Aa(u,p){{var y=function(){xs||(xs=!0,C("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",p))};y.isReactWarning=!0,Object.defineProperty(u,"ref",{get:y,configurable:!0})}}var ka=function(u,p,y,E,D,V,A){var R={$$typeof:e,type:u,key:p,ref:y,props:A,_owner:V};return R._store={},Object.defineProperty(R._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:!1}),Object.defineProperty(R,"_self",{configurable:!1,enumerable:!1,writable:!1,value:E}),Object.defineProperty(R,"_source",{configurable:!1,enumerable:!1,writable:!1,value:D}),Object.freeze&&(Object.freeze(R.props),Object.freeze(R)),R};function Da(u,p,y,E,D){{var V,A={},R=null,re=null;y!==void 0&&(Ke(y),R=""+y),Ca(p)&&(Ke(p.key),R=""+p.key),Ta(p)&&(re=p.ref,Oa(p,D));for(V in p)ne.call(p,V)&&!dt.hasOwnProperty(V)&&(A[V]=p[V]);if(u&&u.defaultProps){var H=u.defaultProps;for(V in H)A[V]===void 0&&(A[V]=H[V])}if(R||re){var G=typeof u=="function"?u.displayName||u.name||"Unknown":u;R&&xa(A,G),re&&Aa(A,G)}return ka(u,R,re,D,E,Be.current,A)}}var Jn=_.ReactCurrentOwner,As=_.ReactDebugCurrentFrame;function Ge(u){if(u){var p=u._owner,y=j(u.type,u._source,p?p.type:null);As.setExtraStackFrame(y)}else As.setExtraStackFrame(null)}var Yn;Yn=!1;function zn(u){return typeof u=="object"&&u!==null&&u.$$typeof===e}function ks(){{if(Jn.current){var u=X(Jn.current.type);if(u)return`

Check the render method of \``+u+"`."}return""}}function La(u){{if(u!==void 0){var p=u.fileName.replace(/^.*[\\\/]/,""),y=u.lineNumber;return`

Check your code at `+p+":"+y+"."}return""}}var Ds={};function Na(u){{var p=ks();if(!p){var y=typeof u=="string"?u:u.displayName||u.name;y&&(p=`

Check the top-level render call using <`+y+">.")}return p}}function Ls(u,p){{if(!u._store||u._store.validated||u.key!=null)return;u._store.validated=!0;var y=Na(p);if(Ds[y])return;Ds[y]=!0;var E="";u&&u._owner&&u._owner!==Jn.current&&(E=" It was passed a child from "+X(u._owner.type)+"."),Ge(u),C('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',y,E),Ge(null)}}function Ns(u,p){{if(typeof u!="object")return;if(ze(u))for(var y=0;y<u.length;y++){var E=u[y];zn(E)&&Ls(E,p)}else if(zn(u))u._store&&(u._store.validated=!0);else if(u){var D=S(u);if(typeof D=="function"&&D!==u.entries)for(var V=D.call(u),A;!(A=V.next()).done;)zn(A.value)&&Ls(A.value,p)}}}function Fa(u){{var p=u.type;if(p==null||typeof p=="string")return;var y;if(typeof p=="function")y=p.propTypes;else if(typeof p=="object"&&(p.$$typeof===l||p.$$typeof===f))y=p.propTypes;else return;if(y){var E=X(p);de(y,u.props,"prop",E,u)}else if(p.PropTypes!==void 0&&!Yn){Yn=!0;var D=X(p);C("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?",D||"Unknown")}typeof p.getDefaultProps=="function"&&!p.getDefaultProps.isReactClassApproved&&C("getDefaultProps is only used on classic React.createClass definitions. Use a static property named `defaultProps` instead.")}}function Pa(u){{for(var p=Object.keys(u.props),y=0;y<p.length;y++){var E=p[y];if(E!=="children"&&E!=="key"){Ge(u),C("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",E),Ge(null);break}}u.ref!==null&&(Ge(u),C("Invalid attribute `ref` supplied to `React.Fragment`."),Ge(null))}}function Fs(u,p,y,E,D,V){{var A=P(u);if(!A){var R="";(u===void 0||typeof u=="object"&&u!==null&&Object.keys(u).length===0)&&(R+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var re=La(D);re?R+=re:R+=ks();var H;u===null?H="null":ze(u)?H="array":u!==void 0&&u.$$typeof===e?(H="<"+(X(u.type)||"Unknown")+" />",R=" Did you accidentally export a JSX literal instead of a component?"):H=typeof u,C("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",H,R)}var G=Da(u,p,y,D,V);if(G==null)return G;if(A){var fe=p.children;if(fe!==void 0)if(E)if(ze(fe)){for(var Xe=0;Xe<fe.length;Xe++)Ns(fe[Xe],u);Object.freeze&&Object.freeze(fe)}else C("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else Ns(fe,u)}return u===r?Pa(G):Fa(G),G}}function Ba(u,p,y){return Fs(u,p,y,!0)}function Ua(u,p,y){return Fs(u,p,y,!1)}var Ia=Ua,Va=Ba;ut.Fragment=r,ut.jsx=Ia,ut.jsxs=Va}()),ut}(function(n){process.env.NODE_ENV==="production"?n.exports=oa():n.exports=aa()})(ws);const ua=ws.exports.jsx,$=d.createContext(null),ca=({url:n="",tokenParams:e,socketPort:t,siteName:r,enableSocket:s=!0,children:i})=>{const o=d.useMemo(()=>{const c=new ji.FrappeApp(n,e);return{url:n,tokenParams:e,app:c,auth:c.auth(),db:c.db(),call:c.call(),file:c.file(),socket:s?new ia(n,r,t,e).socket:void 0,enableSocket:s,socketPort:t}},[n,e,t,s]);return ua($.Provider,{value:o,children:i})},la=n=>{const{url:e,auth:t,tokenParams:r}=d.useContext($),[s,i]=d.useState(),o=d.useCallback(()=>{const b=document.cookie.split(";").find(w=>w.trim().startsWith("user_id="));if(b){const w=b.split("=")[1];i(w&&w!=="Guest"?w:null)}else i(null)},[]);d.useEffect(()=>{r&&r.useToken?i(null):o()},[]);const{data:c,error:l,isLoading:a,isValidating:h,mutate:f}=Me(()=>r&&r.useToken||s?`${e}/api/method/frappe.auth.get_logged_user`:null,()=>t.getLoggedInUser(),{onError:()=>{i(null)},shouldRetryOnError:!1,revalidateOnFocus:!1,...n}),v=d.useCallback(async b=>t.loginWithUsernamePassword(b).then(w=>(o(),w)),[]),g=d.useCallback(async()=>t.logout().then(()=>f(null)).then(()=>i(null)),[]);return{isLoading:s===void 0||a,currentUser:c,isValidating:h,error:l,login:v,logout:g,updateCurrentUser:f,getUserCookie:o}},Wn=(n,e,t)=>{let r=`${e}/api/resource/`;return t?r+=`${n}/${t}`:r+=`${n}`,r},fa=(n,e,t,r)=>{const{url:s,db:i}=d.useContext($);return{...Me(t===void 0?Wn(n,s,e):t,()=>i.getDoc(n,e),r)}},Rs=n=>{var t,r,s;let e="";if(n!=null&&n.fields&&(e+="fields="+JSON.stringify(n==null?void 0:n.fields)+"&"),n!=null&&n.filters&&(e+="filters="+JSON.stringify(n==null?void 0:n.filters)+"&"),n!=null&&n.orFilters&&(e+="or_filters="+JSON.stringify(n==null?void 0:n.orFilters)+"&"),n!=null&&n.limit_start&&(e+="limit_start="+JSON.stringify(n==null?void 0:n.limit_start)+"&"),n!=null&&n.limit&&(e+="limit="+JSON.stringify(n==null?void 0:n.limit)+"&"),n!=null&&n.groupBy&&(e+="group_by="+String(n.groupBy)+"&"),n!=null&&n.orderBy){const i=`${String((t=n.orderBy)==null?void 0:t.field)} ${(s=(r=n.orderBy)==null?void 0:r.order)!=null?s:"asc"}`;e+="order_by="+i+"&"}return n!=null&&n.asDict&&(e+="as_dict="+n.asDict),e},ha=(n,e,t,r)=>{const{url:s,db:i}=d.useContext($);return{...Me(t===void 0?`${Wn(n,s)}?${Rs(e)}`:t,()=>i.getDocList(n,e),r)}},da=()=>{const{db:n}=d.useContext($),[e,t]=d.useState(!1),[r,s]=d.useState(null),[i,o]=d.useState(!1),c=d.useCallback(()=>{t(!1),s(null),o(!1)},[]);return{createDoc:d.useCallback(async(a,h)=>(s(null),o(!1),t(!0),n.createDoc(a,h).then(f=>(t(!1),o(!0),f)).catch(f=>{throw t(!1),o(!1),s(f),f})),[]),loading:e,error:r,isCompleted:i,reset:c}},pa=()=>{const{db:n}=d.useContext($),[e,t]=d.useState(!1),[r,s]=d.useState(null),[i,o]=d.useState(!1),c=d.useCallback(()=>{t(!1),s(null),o(!1)},[]);return{updateDoc:d.useCallback(async(a,h,f)=>(s(null),o(!1),t(!0),n.updateDoc(a,h,f).then(v=>(t(!1),o(!0),v)).catch(v=>{throw t(!1),o(!1),s(v),v})),[]),loading:e,error:r,reset:c,isCompleted:i}},va=()=>{const{db:n}=d.useContext($),[e,t]=d.useState(!1),[r,s]=d.useState(null),[i,o]=d.useState(!1),c=d.useCallback(()=>{t(!1),s(null),o(!1)},[]);return{deleteDoc:d.useCallback(async(a,h)=>(s(null),o(!1),t(!0),n.deleteDoc(a,h).then(f=>(t(!1),o(!0),f)).catch(f=>{throw t(!1),o(!1),s(f),f})),[]),loading:e,error:r,reset:c,isCompleted:i}};function Ts(n){const e=[];for(let t in n)e.push(encodeURIComponent(t)+"="+encodeURIComponent(n[t]));return e.join("&")}const ya=(n,e,t=!1,r=!1,s,i)=>{const{url:o,db:c}=d.useContext($);return{...Me(s===void 0?(()=>{const h=Ts(t?{doctype:n,filters:e!=null?e:[],cache:t,debug:r}:{doctype:n,filters:e!=null?e:[],debug:r});return`${o}/api/method/frappe.client.get_count?${h}`})():s,()=>c.getCount(n,e,t,r),i)}},Cs=(n,e,t,r)=>{const{call:s}=d.useContext($),i=Ts(e!=null?e:{}),o=`${n}?${i}`;return{...Me(t===void 0?o:t,()=>s.get(n,e),r)}},ma=n=>{const{call:e}=d.useContext($),[t,r]=d.useState(null),[s,i]=d.useState(!1),[o,c]=d.useState(null),[l,a]=d.useState(!1),h=d.useCallback(()=>{r(null),i(!1),c(null),a(!1)},[]);return{call:d.useCallback(async v=>(c(null),a(!1),i(!0),r(null),e.post(n,v).then(g=>(r(g),i(!1),a(!0),g)).catch(g=>{throw i(!1),a(!1),c(g),g})),[]),result:t,loading:s,error:o,reset:h,isCompleted:l}},ga=n=>{const{call:e}=d.useContext($),[t,r]=d.useState(null),[s,i]=d.useState(!1),[o,c]=d.useState(null),[l,a]=d.useState(!1),h=d.useCallback(()=>{r(null),i(!1),c(null),a(!1)},[]);return{call:d.useCallback(async v=>(c(null),a(!1),i(!0),r(null),e.put(n,v).then(g=>(r(g),i(!1),a(!0),g)).catch(g=>{throw i(!1),a(!1),c(g),g})),[]),result:t,loading:s,error:o,reset:h,isCompleted:l}},ba=n=>{const{call:e}=d.useContext($),[t,r]=d.useState(null),[s,i]=d.useState(!1),[o,c]=d.useState(null),[l,a]=d.useState(!1),h=d.useCallback(()=>{r(null),i(!1),c(null),a(!1)},[]);return{call:d.useCallback(async v=>(c(null),a(!1),i(!0),r(null),e.delete(n,v).then(g=>(r(g),i(!1),a(!0),g)).catch(g=>{throw i(!1),a(!1),c(g),g})),[]),result:t,loading:s,error:o,reset:h,isCompleted:l}},_a=()=>{const{file:n}=d.useContext($),[e,t]=d.useState(0),[r,s]=d.useState(!1),[i,o]=d.useState(null),[c,l]=d.useState(!1),a=d.useCallback(async(f,v,g)=>(h(),s(!0),n.uploadFile(f,v,(b,w)=>t(Math.round(b/w*100)),g).then(b=>(l(!0),t(100),s(!1),b.data.message)).catch(b=>{throw console.error(b),o(b),s(!1),b})),[]),h=d.useCallback(()=>{t(0),s(!1),o(null),l(!1)},[]);return{upload:a,progress:e,loading:r,isCompleted:c,error:i,reset:h}},wa=(n,e,t=[],r=20,s=250)=>{const i=Ea(e,s);return Cs("frappe.desk.search.search_link",{doctype:n,page_length:r,txt:i,filters:JSON.stringify(t!=null?t:[])})},Ea=(n,e)=>{const[t,r]=d.useState(n);return d.useEffect(()=>{const s=setTimeout(()=>{r(n)},e);return()=>{clearTimeout(s)}},[n,e]),t},Ut=(n,e)=>{const{socket:t}=d.useContext($);d.useEffect(()=>{t===void 0&&console.warn("Socket is not enabled. Please enable socket in FrappeProvider.");let r=t==null?void 0:t.on(n,e);return()=>{r==null||r.off(n)}},[n,e])},Sa=(n,e,t,r=!0)=>{const{socket:s}=d.useContext($),[i,o]=d.useState([]);d.useEffect(()=>(s===void 0&&console.warn("Socket is not enabled. Please enable socket in FrappeProvider."),s==null||s.emit("doc_subscribe",n,e),r&&(s==null||s.emit("doc_open",n,e)),()=>{s==null||s.emit("doc_unsubscribe",n,e),r&&(s==null||s.emit("doc_close",n,e))}),[n,e,r]),Ut("doc_update",t);const c=d.useCallback(()=>{s==null||s.emit("doc_open",n,e)},[n,e]),l=d.useCallback(()=>{s==null||s.emit("doc_close",n,e)},[n,e]),a=d.useCallback(h=>{h.doctype===n&&h.docname===e&&o(h.users)},[n,e]);return Ut("doc_viewers",a),{viewers:i,emitDocOpen:c,emitDocClose:l}},Ra=(n,e)=>{const{socket:t}=d.useContext($);d.useEffect(()=>(t===void 0&&console.warn("Socket is not enabled. Please enable socket in FrappeProvider."),t==null||t.emit("doctype_subscribe",n),()=>{t==null||t.emit("doctype_unsubscribe",n)}),[n]),Ut("list_update",e)};x.FrappeContext=$,x.FrappeProvider=ca,x.getDocListQueryString=Rs,x.getRequestURL=Wn,x.useFrappeAuth=la,x.useFrappeCreateDoc=da,x.useFrappeDeleteCall=ba,x.useFrappeDeleteDoc=va,x.useFrappeDocTypeEventListener=Ra,x.useFrappeDocumentEventListener=Sa,x.useFrappeEventListener=Ut,x.useFrappeFileUpload=_a,x.useFrappeGetCall=Cs,x.useFrappeGetDoc=fa,x.useFrappeGetDocCount=ya,x.useFrappeGetDocList=ha,x.useFrappePostCall=ma,x.useFrappePutCall=ga,x.useFrappeUpdateDoc=pa,x.useSWR=Me,x.useSWRConfig=Xr,x.useSearch=wa,Object.defineProperties(x,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
